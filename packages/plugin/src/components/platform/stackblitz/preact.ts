...
export const openPreactStackblitz = (params: PlatformParams) => {
  ...
  stackblitz.openProject(
    {
      ...
      files: {
        ...params.sourceFiles,
        'src/App.tsx': code,
        'src/main.tsx': genMainTs(ComponentType.PREACT),
        ...
        'vite.config.ts': genViteConfig(ComponentType.PREACT),
        '.stackblitzrc': genStackblitzRc(),
        'tsconfig.json': genTsConfig(ComponentType.PREACT),
        ...params.customFiles,
      },
    },
    {
